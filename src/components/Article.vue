        ...
        <div class="foot-btn">
            <ul>
                ...
                <li class="xing"><a href="javascript:;">
                    <i><img src="../assets/images/xing.png" alt=""/></i>
                </a></li>
                <li class="fx"><a href="javascript:;">
                    <i><img src="../assets/images/fx.png" alt=""/></i>
                </a></li>
            </ul>
        </div>
    </div>
...
<style scoped>
    ...
    .nav ul li{width:0.29rem;height:0.31rem; background:url(../assets/images/history.png) no-repeat 0 0; background-size:100%; margin:0 0 0 0.38rem;}
    ...
    .header h2{ float:left;margin-right:0.18rem;width: 1.02rem; height: 1.02rem;border-radius: 50%;}
    .header h2 img{max-width:100%;max-height:100%;}
    ...
    .say i{width:0.36rem;height:0.26rem; background:url(../assets/images/say.png) no-repeat 0 0; background-size:100%; float:left; margin-left:0.7rem; margin-top:0.13rem;}
    ...
    .zan i{width:0.36rem;height:0.28rem; background:url(../assets/images/zan1.png) no-repeat 0 0; background-size:100%; float:left; margin-left:0.54rem; margin-top:0.13rem;}
